...
import line_vert from '../../assets/shaders/fluid/line.vert'
import advection_frag from '../../assets/shaders/fluid/advection.frag'
...
export default class Advection extends ShaderPass {
	...
	createBoundary() {
		const boundaryG = new THREE.PlaneGeometry()
